...
export ZSH="/Users/tylerwood/.oh-my-zsh"
...
# set helpful env vars

# Aliases
alias sz="source ~/.zshrc"
alias cdmwaa="cd ~/naked/repos/mwaa; ll"
alias cddags="cd ~/naked/repos/mwaa/dags; ll"
alias cdops="cd ~/naked/repos/mwaa/dags/naked_operators; ll"

alias ccat='pygmentize -g'
alias dexec='docker exec -it docker_local-runner_1 /bin/sh'

export FLINK_PATH='/usr/local/Cellar/apache-flink/1.16.1/libexec'
